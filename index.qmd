...
Further, we must rethink how we allocate labor.

Load-bearing datasets require more effort than the initial collection
and subsequent distribution, but also maintenance. This beyond research
required to create useful datasets, we also require resources to
maintain them.
